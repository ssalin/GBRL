...
//SETTINGS
#define SAMPLE_MINS 5 //how many minutes to sample for.
/****************/
/***PINMAPPING***/
/****************/
...
void wakeup() {
  Serial.println(F("in IRQ VECTOR SONN"));
  rtc.alarm2();
  if(rtc.alarm1())
    flag = 1;
    sleepalarm();   
...
void onEvent (ev_t ev) {
    ...
    switch(ev) {
        ...
        case EV_REJOIN_FAILED:
            ...
            break;
            break;
        case EV_TXCOMPLETE: //should put sleep in here to make sure data is transmitted?
